...
public class RegisScreen implements Screen{
    final Game24 game;
    private Stage stage;
    ...
    public RegisScreen(Game24 game) {
        Net.HttpRequest request;
        user1 = new user();
        this.game = game;
        ...
        TextButton btnLogin = new TextButton("Register",skin);
        ...
        styletext.font.getData().setScale(5f);
    ...
    public void btnLoginClicked(){
        ...
        request.setUrl("localhost:8000/public/register");//Ganti sesuai ip address lewat cmd
    ...
    public void render(float delta) {
        ...
        font.draw(game.batch,"REGISTER",100,1600);
        game.batch.end();
